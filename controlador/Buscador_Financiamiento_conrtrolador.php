...
//$query ="SELECT C.nombre_cliente, F.Fecha_Financ FROM clientes WHERE nombre_cliente LIKE LOWER('%".$_POST["buscar"]."%')";
    $query = "SELECT CLI.NOMBRE_CLIENTE ,FIN.FECHA_FINANC, FIN.IMEI, ART.DESCRIPCION_ART
...
if ($resultado_consulta == null) {
    echo "<h5>El codigo de financiemiento no coincide con algun financiamineto Activo, porfavor ingrese un codigo valido.</h5>";
} else {?>
